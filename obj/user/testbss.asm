...
umain(int argc, char **argv)
{
  ...
  80003e:	e8 c2 01 00 00       	call   800205 <cprintf>
  ...
  800062:	e8 c5 00 00 00       	call   80012c <_panic>
umain(int argc, char **argv)
{
	int i;
  ...
  8000a2:	e8 85 00 00 00       	call   80012c <_panic>
	for (i = 0; i < ARRAYSIZE; i++)
		if (bigarray[i] != 0)
			panic("bigarray[%d] isn't cleared!\n", i);
	for (i = 0; i < ARRAYSIZE; i++)
  ...
  8000b9:	e8 47 01 00 00       	call   800205 <cprintf>
  ...
  8000d7:	e8 50 00 00 00       	call   80012c <_panic>
...
libmain(int argc, char **argv)
{
  ...
  8000e7:	e8 e2 0a 00 00       	call   800bce <sys_getenvid>
	thisenv = envs;
  8000ec:	c7 05 20 20 c0 00 00 	movl   $0xeec00000,0xc02020
  8000f3:	00 c0 ee 
	// save the name of the program so that panic() can use it
	if (argc > 0)
  8000f6:	85 db                	test   %ebx,%ebx
  8000f8:	7e 07                	jle    800101 <libmain+0x25>
		binaryname = argv[0];
  ...
  800104:	56                   	push   %esi
  800105:	53                   	push   %ebx
  800106:	e8 28 ff ff ff       	call   800033 <umain>
...
exit(void)
{
  ...
  800122:	e8 66 0a 00 00       	call   800b8d <sys_env_destroy>
}
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80013a:	e8 8f 0a 00 00       	call   800bce <sys_getenvid>
  80013f:	83 ec 0c             	sub    $0xc,%esp
  800142:	ff 75 0c             	pushl  0xc(%ebp)
  800145:	ff 75 08             	pushl  0x8(%ebp)
  800148:	56                   	push   %esi
  800149:	50                   	push   %eax
  80014a:	68 48 0f 80 00       	push   $0x800f48
  ...
  80015b:	e8 54 00 00 00       	call   8001b4 <vcprintf>
	cprintf("\n");
  800160:	c7 04 24 16 0f 80 00 	movl   $0x800f16,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  80019c:	50                   	push   %eax
  80019d:	e8 ae 09 00 00       	call   800b50 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8001f7:	50                   	push   %eax
  8001f8:	e8 53 09 00 00       	call   800b50 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800268:	e8 83 09 00 00       	call   800bf0 <__udivdi3>
  ...
  8002ab:	e8 70 0a 00 00       	call   800d20 <__umoddi3>
  8002b0:	83 c4 14             	add    $0x14,%esp
  8002b3:	0f be 80 6c 0f 80 00 	movsbl 0x800f6c(%eax),%eax
  8002ba:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800375:	ff 24 85 00 10 80 00 	jmp    *0x801000(,%eax,4)
  ...
  80043c:	8b 14 85 60 11 80 00 	mov    0x801160(,%eax,4),%edx
  800443:	85 d2                	test   %edx,%edx
  800445:	75 1b                	jne    800462 <vprintfmt+0x160>
				printfmt(putch, putdat, "error %d", err);
  800447:	50                   	push   %eax
  800448:	68 84 0f 80 00       	push   $0x800f84
  80044d:	53                   	push   %ebx
  80044e:	56                   	push   %esi
  ...
  800462:	52                   	push   %edx
  800463:	68 8d 0f 80 00       	push   $0x800f8d
  800468:	53                   	push   %ebx
  800469:	56                   	push   %esi
  ...
  80048d:	b8 7d 0f 80 00       	mov    $0x800f7d,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800bb5:	68 80 11 80 00       	push   $0x801180
  800bba:	6a 23                	push   $0x23
  800bbc:	68 9d 11 80 00       	push   $0x80119d
  800bc1:	e8 66 f5 ff ff       	call   80012c <_panic>
