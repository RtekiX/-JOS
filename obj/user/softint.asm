...
libmain(int argc, char **argv)
{
  ...
  800045:	e8 be 00 00 00       	call   800108 <sys_getenvid>
	thisenv = envs;
  80004a:	c7 05 04 20 80 00 00 	movl   $0xeec00000,0x802004
  800051:	00 c0 ee 
	// save the name of the program so that panic() can use it
	if (argc > 0)
  800054:	85 db                	test   %ebx,%ebx
  800056:	7e 07                	jle    80005f <libmain+0x25>
		binaryname = argv[0];
  800058:	8b 06                	mov    (%esi),%eax
  80005a:	a3 00 20 80 00       	mov    %eax,0x802000

	// call user main routine
	umain(argc, argv);
  80005f:	83 ec 08             	sub    $0x8,%esp
  800062:	56                   	push   %esi
  800063:	53                   	push   %ebx
  800064:	e8 ca ff ff ff       	call   800033 <umain>

	// exit gracefully
	exit();
  800069:	e8 0a 00 00 00       	call   800078 <exit>
}
  80006e:	83 c4 10             	add    $0x10,%esp
  800071:	8d 65 f8             	lea    -0x8(%ebp),%esp
  800074:	5b                   	pop    %ebx
  800075:	5e                   	pop    %esi
  800076:	5d                   	pop    %ebp
  800077:	c3                   	ret    
...
sys_env_destroy(envid_t envid)
{
  ...
  8000ef:	68 ea 0d 80 00       	push   $0x800dea
  8000f4:	6a 23                	push   $0x23
  8000f6:	68 07 0e 80 00       	push   $0x800e07
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800143:	56                   	push   %esi
  800144:	50                   	push   %eax
  800145:	68 18 0e 80 00       	push   $0x800e18
  ...
  800156:	e8 54 00 00 00       	call   8001af <vcprintf>
	cprintf("\n");
  80015b:	c7 04 24 3c 0e 80 00 	movl   $0x800e3c,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002ae:	0f be 80 3e 0e 80 00 	movsbl 0x800e3e(%eax),%eax
  8002b5:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800370:	ff 24 85 e0 0e 80 00 	jmp    *0x800ee0(,%eax,4)
  ...
  800437:	8b 14 85 40 10 80 00 	mov    0x801040(,%eax,4),%edx
  80043e:	85 d2                	test   %edx,%edx
  800440:	75 1b                	jne    80045d <vprintfmt+0x160>
				printfmt(putch, putdat, "error %d", err);
  800442:	50                   	push   %eax
  800443:	68 56 0e 80 00       	push   $0x800e56
  800448:	53                   	push   %ebx
  800449:	56                   	push   %esi
  ...
  80045d:	52                   	push   %edx
  80045e:	68 5f 0e 80 00       	push   $0x800e5f
  800463:	53                   	push   %ebx
  800464:	56                   	push   %esi
  ...
  800488:	b8 4f 0e 80 00       	mov    $0x800e4f,%eax
