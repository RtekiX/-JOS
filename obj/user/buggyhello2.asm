...
umain(int argc, char **argv)
{
  ...
  800044:	e8 55 00 00 00       	call   80009e <sys_cputs>
}
...
libmain(int argc, char **argv)
{
  ...
  800059:	e8 be 00 00 00       	call   80011c <sys_getenvid>
	thisenv = envs;
  80005e:	c7 05 08 20 80 00 00 	movl   $0xeec00000,0x802008
  800065:	00 c0 ee 
...
sys_env_destroy(envid_t envid)
{
  ...
  800103:	68 18 0e 80 00       	push   $0x800e18
  800108:	6a 23                	push   $0x23
  80010a:	68 35 0e 80 00       	push   $0x800e35
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800143:	8b 35 04 20 80 00    	mov    0x802004,%esi
  ...
  800157:	56                   	push   %esi
  800158:	50                   	push   %eax
  800159:	68 44 0e 80 00       	push   $0x800e44
  ...
  80016a:	e8 54 00 00 00       	call   8001c3 <vcprintf>
	cprintf("\n");
  80016f:	c7 04 24 0c 0e 80 00 	movl   $0x800e0c,(%esp)
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8001f2:	e8 1a 01 00 00       	call   800311 <vprintfmt>
	sys_cputs(b.buf, b.idx);
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800277:	e8 e4 08 00 00       	call   800b60 <__udivdi3>
  ...
  8002ba:	e8 d1 09 00 00       	call   800c90 <__umoddi3>
  8002bf:	83 c4 14             	add    $0x14,%esp
  8002c2:	0f be 80 68 0e 80 00 	movsbl 0x800e68(%eax),%eax
  8002c9:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800327:	0f 84 42 04 00 00    	je     80076f <vprintfmt+0x45e>
				return;
			putch(ch, putdat);
  ...
  80037b:	0f 87 d3 03 00 00    	ja     800754 <vprintfmt+0x443>
  800381:	0f b6 c0             	movzbl %al,%eax
  800384:	ff 24 85 00 0f 80 00 	jmp    *0x800f00(,%eax,4)
  ...
  8003af:	77 3f                	ja     8003f0 <vprintfmt+0xdf>
		case '5':
		case '6':
		case '7':
		case '8':
  ...
  8003c7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		...
		case '*':
			precision = va_arg(ap, int);
			goto process_precision;
  8003ca:	eb 2a                	jmp    8003f6 <vprintfmt+0xe5>
  8003cc:	8b 45 e0             	mov    -0x20(%ebp),%eax
  8003cf:	85 c0                	test   %eax,%eax
  8003d1:	ba 00 00 00 00       	mov    $0x0,%edx
  8003d6:	0f 49 d0             	cmovns %eax,%edx
  8003d9:	89 55 e0             	mov    %edx,-0x20(%ebp)
		width = -1;
		precision = -1;
		lflag = 0;
		altflag = 0;
  ...
  8003df:	eb 89                	jmp    80036a <vprintfmt+0x59>
  ...
  8003e4:	c7 45 d8 01 00 00 00 	movl   $0x1,-0x28(%ebp)
			goto reswitch;
  8003eb:	e9 7a ff ff ff       	jmp    80036a <vprintfmt+0x59>
  ...
  8003fa:	0f 89 6a ff ff ff    	jns    80036a <vprintfmt+0x59>
				width = precision, precision = -1;
  800400:	8b 45 d0             	mov    -0x30(%ebp),%eax
  800403:	89 45 e0             	mov    %eax,-0x20(%ebp)
  800406:	c7 45 d0 ff ff ff ff 	movl   $0xffffffff,-0x30(%ebp)
  80040d:	e9 58 ff ff ff       	jmp    80036a <vprintfmt+0x59>
			goto reswitch;
  ...
  800415:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		...
		case 'l':
			lflag++;
			goto reswitch;
  800418:	e9 4d ff ff ff       	jmp    80036a <vprintfmt+0x59>
  ...
  800431:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		...
		case 'c':
			putch(va_arg(ap, int), putdat);
			break;
  800434:	e9 fe fe ff ff       	jmp    800337 <vprintfmt+0x26>
  ...
  800446:	83 f8 07             	cmp    $0x7,%eax
  800449:	7f 0b                	jg     800456 <vprintfmt+0x145>
  80044b:	8b 14 85 60 10 80 00 	mov    0x801060(,%eax,4),%edx
  800452:	85 d2                	test   %edx,%edx
  800454:	75 1b                	jne    800471 <vprintfmt+0x160>
				printfmt(putch, putdat, "error %d", err);
  800456:	50                   	push   %eax
  800457:	68 80 0e 80 00       	push   $0x800e80
  80045c:	53                   	push   %ebx
  80045d:	56                   	push   %esi
  80045e:	e8 91 fe ff ff       	call   8002f4 <printfmt>
  ...
  800469:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		case 'e':
			...
			if (err >= MAXERROR || (p = error_string[err]) == NULL)
				printfmt(putch, putdat, "error %d", err);
  80046c:	e9 c6 fe ff ff       	jmp    800337 <vprintfmt+0x26>
			else
				printfmt(putch, putdat, "%s", p);
  800471:	52                   	push   %edx
  800472:	68 89 0e 80 00       	push   $0x800e89
  800477:	53                   	push   %ebx
  800478:	56                   	push   %esi
  800479:	e8 76 fe ff ff       	call   8002f4 <printfmt>
  ...
  800487:	e9 ab fe ff ff       	jmp    800337 <vprintfmt+0x26>
				printfmt(putch, putdat, "%s", p);
			break;
  ...
  8004f3:	8b 4d c8             	mov    -0x38(%ebp),%ecx
  ...
  80052e:	eb 0d                	jmp    80053d <vprintfmt+0x22c>
				else
					putch(ch, putdat);
  ...
  800540:	eb 1a                	jmp    80055c <vprintfmt+0x24b>
  ...
  80054e:	eb 0c                	jmp    80055c <vprintfmt+0x24b>
  ...
  800568:	74 23                	je     80058d <vprintfmt+0x27c>
  80056a:	85 f6                	test   %esi,%esi
  80056c:	78 a1                	js     80050f <vprintfmt+0x1fe>
  80056e:	83 ee 01             	sub    $0x1,%esi
  800571:	79 9c                	jns    80050f <vprintfmt+0x1fe>
  800573:	89 df                	mov    %ebx,%edi
  800575:	8b 75 08             	mov    0x8(%ebp),%esi
  800578:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  80057b:	eb 18                	jmp    800595 <vprintfmt+0x284>
				if (altflag && (ch < ' ' || ch > '~'))
					putch('?', putdat);
				else
					putch(ch, putdat);
  ...
  800597:	7f e4                	jg     80057d <vprintfmt+0x26c>
		...
		case 's':
			if ((p = va_arg(ap, char *)) == NULL)
  800599:	8b 45 cc             	mov    -0x34(%ebp),%eax
  ...
  8005a2:	e9 90 fd ff ff       	jmp    800337 <vprintfmt+0x26>
...
getint(va_list *ap, int lflag)
{
  ...
  8005aa:	7e 19                	jle    8005c5 <vprintfmt+0x2b4>
  ...
  8005c3:	eb 38                	jmp    8005fd <vprintfmt+0x2ec>
	else if (lflag)
  8005c5:	85 c9                	test   %ecx,%ecx
  8005c7:	74 1b                	je     8005e4 <vprintfmt+0x2d3>
  ...
  8005e2:	eb 19                	jmp    8005fd <vprintfmt+0x2ec>
	else
  ...
  80060c:	0f 89 0e 01 00 00    	jns    800720 <vprintfmt+0x40f>
				putch('-', putdat);
  ...
  80062f:	e9 ec 00 00 00       	jmp    800720 <vprintfmt+0x40f>
...
getuint(va_list *ap, int lflag)
{
  ...
  800637:	7e 18                	jle    800651 <vprintfmt+0x340>
  ...
  80064c:	e9 cf 00 00 00       	jmp    800720 <vprintfmt+0x40f>
static unsigned long long
getuint(va_list *ap, int lflag)
{
	if (lflag >= 2)
  ...
  800653:	74 1a                	je     80066f <vprintfmt+0x35e>
  ...
  80066a:	e9 b1 00 00 00       	jmp    800720 <vprintfmt+0x40f>
	if (lflag >= 2)
		return va_arg(*ap, unsigned long long);
	else if (lflag)
		return va_arg(*ap, unsigned long);
  ...
  800684:	e9 97 00 00 00       	jmp    800720 <vprintfmt+0x40f>
			goto number;
  ...
  8006a4:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		case 'o':
			...
			putch('X', putdat);
			break;
  8006a7:	e9 8b fc ff ff       	jmp    800337 <vprintfmt+0x26>
  ...
  8006cf:	b8 10 00 00 00       	mov    $0x10,%eax
			goto number;
  8006d4:	eb 4a                	jmp    800720 <vprintfmt+0x40f>
// Get an unsigned int of various possible sizes from a varargs list,
// depending on the lflag parameter.
static unsigned long long
getuint(va_list *ap, int lflag)
{
  ...
  8006d9:	7e 15                	jle    8006f0 <vprintfmt+0x3df>
		return va_arg(*ap, unsigned long long);
  ...
  8006ee:	eb 30                	jmp    800720 <vprintfmt+0x40f>
static unsigned long long
getuint(va_list *ap, int lflag)
{
	if (lflag >= 2)
  ...
  8006f2:	74 17                	je     80070b <vprintfmt+0x3fa>
		return va_arg(*ap, unsigned long);
  ...
  800709:	eb 15                	jmp    800720 <vprintfmt+0x40f>
	if (lflag >= 2)
		return va_arg(*ap, unsigned long long);
	else if (lflag)
		return va_arg(*ap, unsigned long);
  ...
  800723:	0f be 7d d4          	movsbl -0x2c(%ebp),%edi
  800727:	57                   	push   %edi
  ...
  800732:	e8 f1 fa ff ff       	call   800228 <printnum>
			break;
  800737:	83 c4 20             	add    $0x20,%esp
  80073a:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  80073d:	e9 f5 fb ff ff       	jmp    800337 <vprintfmt+0x26>
  ...
  80074c:	8b 7d e4             	mov    -0x1c(%ebp),%edi
		...
		case '%':
			putch(ch, putdat);
			break;
  80074f:	e9 e3 fb ff ff       	jmp    800337 <vprintfmt+0x26>
  ...
  80075f:	eb 03                	jmp    800764 <vprintfmt+0x453>
  800761:	83 ef 01             	sub    $0x1,%edi
  800764:	80 7f ff 25          	cmpb   $0x25,-0x1(%edi)
  800768:	75 f7                	jne    800761 <vprintfmt+0x450>
  80076a:	e9 c8 fb ff ff       	jmp    800337 <vprintfmt+0x26>
				/* do nothing */;
			break;
		}
	}
...
vsnprintf(char *buf, int n, const char *fmt, va_list ap)
{
  ...
  80079a:	7e 22                	jle    8007be <vsnprintf+0x47>
		return -E_INVAL;
  ...
  8007a5:	50                   	push   %eax
  8007a6:	68 d7 02 80 00       	push   $0x8002d7
  8007ab:	e8 61 fb ff ff       	call   800311 <vprintfmt>
  ...
  8007bc:	eb 05                	jmp    8007c3 <vsnprintf+0x4c>
vsnprintf(char *buf, int n, const char *fmt, va_list ap)
{
	struct sprintbuf b = {buf, buf+n-1, 0};
...
snprintf(char *buf, int n, const char *fmt, ...)
{
  ...
  8007d8:	e8 9a ff ff ff       	call   800777 <vsnprintf>
	va_end(ap);
...
strlen(const char *s)
{
  ...
  8007ea:	eb 03                	jmp    8007ef <strlen+0x10>
		n++;
...
strlen(const char *s)
{
  ...
  8007f3:	75 f7                	jne    8007ec <strlen+0xd>
		n++;
	return n;
}
  8007f5:	5d                   	pop    %ebp
...
strnlen(const char *s, size_t size)
{
  ...
  800805:	eb 03                	jmp    80080a <strnlen+0x13>
		n++;
...
strnlen(const char *s, size_t size)
{
  ...
  80080c:	74 08                	je     800816 <strnlen+0x1f>
  80080e:	80 3c 11 00          	cmpb   $0x0,(%ecx,%edx,1)
  800812:	75 f3                	jne    800807 <strnlen+0x10>
...
strcat(char *dst, const char *src)
{
  ...
  80083c:	8b 5d 08             	mov    0x8(%ebp),%ebx
	int len = strlen(dst);
  80083f:	53                   	push   %ebx
  800840:	e8 9a ff ff ff       	call   8007df <strlen>
...
strlcpy(char *dst, const char *src, size_t size)
{
  ...
  800899:	74 21                	je     8008bc <strlcpy+0x35>
  80089b:	8d 44 16 ff          	lea    -0x1(%esi,%edx,1),%eax
  80089f:	89 f2                	mov    %esi,%edx
  8008a1:	eb 09                	jmp    8008ac <strlcpy+0x25>
		while (--size > 0 && *src != '\0')
			*dst++ = *src++;
  ...
  8008a9:	88 5a ff             	mov    %bl,-0x1(%edx)
{
  ...
  8008ae:	74 09                	je     8008b9 <strlcpy+0x32>
  8008b0:	0f b6 19             	movzbl (%ecx),%ebx
  8008b3:	84 db                	test   %bl,%bl
  8008b5:	75 ec                	jne    8008a3 <strlcpy+0x1c>
...
strncmp(const char *p, const char *q, size_t n)
{
  ...
  800901:	74 15                	je     800918 <strncmp+0x30>
  ...
  800916:	eb 05                	jmp    80091d <strncmp+0x35>
strncmp(const char *p, const char *q, size_t n)
{
	while (n > 0 && *p && *p == *q)
		n--, p++, q++;
...
strchr(const char *s, char c)
{
  ...
  800926:	0f b6 4d 0c          	movzbl 0xc(%ebp),%ecx
	for (; *s; s++)
  80092a:	eb 07                	jmp    800933 <strchr+0x13>
		if (*s == c)
  80092c:	38 ca                	cmp    %cl,%dl
  80092e:	74 0f                	je     80093f <strchr+0x1f>
// Return a pointer to the first occurrence of 'c' in 's',
// or a null pointer if the string has no 'c'.
char *
strchr(const char *s, char c)
...
memset(void *v, int c, size_t n)
{
  ...
  80096b:	74 36                	je     8009a3 <memset+0x46>
		return v;
	if ((int)v%4 == 0 && n%4 == 0) {
  80096d:	f7 c7 03 00 00 00    	test   $0x3,%edi
  800973:	75 28                	jne    80099d <memset+0x40>
  800975:	f6 c1 03             	test   $0x3,%cl
  800978:	75 23                	jne    80099d <memset+0x40>
		c &= 0xFF;
...
memmove(void *dst, const void *src, size_t n)
{
  ...
  8009c1:	73 2e                	jae    8009f1 <memmove+0x47>
		s += n;
		d += n;
  ...
  8009d0:	75 13                	jne    8009e5 <memmove+0x3b>
  8009d2:	f6 c1 03             	test   $0x3,%cl
  8009d5:	75 0e                	jne    8009e5 <memmove+0x3b>
  ...
  8009e3:	eb 09                	jmp    8009ee <memmove+0x44>
...
memcmp(const void *v1, const void *v2, size_t n)
{
  ...
  800a32:	03 75 10             	add    0x10(%ebp),%esi
	...
	while (n-- > 0) {
  800a35:	eb 1a                	jmp    800a51 <memcmp+0x2c>
		if (*s1 != *s2)
  800a37:	0f b6 08             	movzbl (%eax),%ecx
  800a3a:	0f b6 1a             	movzbl (%edx),%ebx
  800a3d:	38 d9                	cmp    %bl,%cl
  800a3f:	74 0a                	je     800a4b <memcmp+0x26>
			return (int) *s1 - (int) *s2;
  800a41:	0f b6 c1             	movzbl %cl,%eax
  800a44:	0f b6 db             	movzbl %bl,%ebx
  800a47:	29 d8                	sub    %ebx,%eax
  800a49:	eb 0f                	jmp    800a5a <memcmp+0x35>
		s1++, s2++;
...
memcmp(const void *v1, const void *v2, size_t n)
{
  ...
  800a53:	75 e2                	jne    800a37 <memcmp+0x12>
		if (*s1 != *s2)
			return (int) *s1 - (int) *s2;
		s1++, s2++;
	}
...
memfind(const void *s, int c, size_t n)
{
  ...
  800a65:	89 c1                	mov    %eax,%ecx
  800a67:	03 4d 10             	add    0x10(%ebp),%ecx
	for (; s < ends; s++)
		if (*(const unsigned char *) s == (unsigned char) c)
  800a6a:	0f b6 5d 0c          	movzbl 0xc(%ebp),%ebx
...
memfind(const void *s, int c, size_t n)
{
	const void *ends = (const char *) s + n;
	for (; s < ends; s++)
  800a6e:	eb 0a                	jmp    800a7a <memfind+0x1c>
		if (*(const unsigned char *) s == (unsigned char) c)
  800a70:	0f b6 10             	movzbl (%eax),%edx
  800a73:	39 da                	cmp    %ebx,%edx
  800a75:	74 07                	je     800a7e <memfind+0x20>
...
memfind(const void *s, int c, size_t n)
{
  ...
  800a7a:	39 c8                	cmp    %ecx,%eax
  800a7c:	72 f2                	jb     800a70 <memfind+0x12>
		if (*(const unsigned char *) s == (unsigned char) c)
			break;
	return (void *) s;
}
...
strtol(const char *s, char **endptr, int base)
{
  ...
  800a8a:	8b 5d 10             	mov    0x10(%ebp),%ebx
	...
	while (*s == ' ' || *s == '\t')
  800a8d:	eb 03                	jmp    800a92 <strtol+0x11>
		s++;
  800a8f:	83 c1 01             	add    $0x1,%ecx
{
  ...
  800a97:	74 f6                	je     800a8f <strtol+0xe>
  800a99:	3c 09                	cmp    $0x9,%al
  800a9b:	74 f2                	je     800a8f <strtol+0xe>
		s++;

	// plus/minus sign
	if (*s == '+')
  800a9d:	3c 2b                	cmp    $0x2b,%al
  800a9f:	75 0a                	jne    800aab <strtol+0x2a>
		s++;
...
strtol(const char *s, char **endptr, int base)
{
  ...
  800aa9:	eb 11                	jmp    800abc <strtol+0x3b>
  ...
  800ab2:	75 08                	jne    800abc <strtol+0x3b>
		s++, neg = 1;
  ...
  800ac2:	75 15                	jne    800ad9 <strtol+0x58>
  800ac4:	80 39 30             	cmpb   $0x30,(%ecx)
  800ac7:	75 10                	jne    800ad9 <strtol+0x58>
  800ac9:	80 79 01 78          	cmpb   $0x78,0x1(%ecx)
  800acd:	75 7c                	jne    800b4b <strtol+0xca>
		s += 2, base = 16;
  800acf:	83 c1 02             	add    $0x2,%ecx
  800ad2:	bb 10 00 00 00       	mov    $0x10,%ebx
  800ad7:	eb 16                	jmp    800aef <strtol+0x6e>
	else if (base == 0 && s[0] == '0')
  800ad9:	85 db                	test   %ebx,%ebx
  800adb:	75 12                	jne    800aef <strtol+0x6e>
		s++, base = 8;
	else if (base == 0)
		base = 10;
  800add:	bb 0a 00 00 00       	mov    $0xa,%ebx
		s++, neg = 1;
  ...
  800ae5:	75 08                	jne    800aef <strtol+0x6e>
		s++, base = 8;
  ...
  800b2b:	83 ea 37             	sub    $0x37,%edx
			...
			break;
		if (dig >= base)
  800b2e:	3b 55 10             	cmp    0x10(%ebp),%edx
  800b31:	7d 0b                	jge    800b3e <strtol+0xbd>
			break;
		s++, val = (val * base) + dig;
  800b33:	83 c1 01             	add    $0x1,%ecx
  800b36:	0f af 45 10          	imul   0x10(%ebp),%eax
  800b3a:	01 d0                	add    %edx,%eax
		// we don't properly detect overflow!
	}
  800b3c:	eb b9                	jmp    800af7 <strtol+0x76>

	if (endptr)
  800b3e:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
  800b42:	74 0d                	je     800b51 <strtol+0xd0>
		*endptr = (char *) s;
  800b44:	8b 75 0c             	mov    0xc(%ebp),%esi
  800b47:	89 0e                	mov    %ecx,(%esi)
  800b49:	eb 06                	jmp    800b51 <strtol+0xd0>
		s++, neg = 1;
  ...
  800b4d:	74 98                	je     800ae7 <strtol+0x66>
  800b4f:	eb 9e                	jmp    800aef <strtol+0x6e>
		// we don't properly detect overflow!
	}
  ...
  800b57:	0f 45 c2             	cmovne %edx,%eax
}
  800b5a:	5b                   	pop    %ebx
  800b5b:	5e                   	pop    %esi
  800b5c:	5f                   	pop    %edi
