	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800249:	e8 e2 0b 00 00       	call   800e30 <__udivdi3>
  ...
  80028c:	e8 cf 0c 00 00       	call   800f60 <__umoddi3>
...
sys_env_destroy(envid_t envid)
{
  ...
  800b96:	68 a8 13 80 00       	push   $0x8013a8
  800b9b:	6a 23                	push   $0x23
  800b9d:	68 c5 13 80 00       	push   $0x8013c5
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c17:	68 a8 13 80 00       	push   $0x8013a8
  800c1c:	6a 23                	push   $0x23
  800c1e:	68 c5 13 80 00       	push   $0x8013c5
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c59:	68 a8 13 80 00       	push   $0x8013a8
  800c5e:	6a 23                	push   $0x23
  800c60:	68 c5 13 80 00       	push   $0x8013c5
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c9b:	68 a8 13 80 00       	push   $0x8013a8
  800ca0:	6a 23                	push   $0x23
  800ca2:	68 c5 13 80 00       	push   $0x8013c5
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cdd:	68 a8 13 80 00       	push   $0x8013a8
  800ce2:	6a 23                	push   $0x23
  800ce4:	68 c5 13 80 00       	push   $0x8013c5
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d1f:	68 a8 13 80 00       	push   $0x8013a8
  800d24:	6a 23                	push   $0x23
  800d26:	68 c5 13 80 00       	push   $0x8013c5
...
sys_ipc_recv(void *dstva)
{
  ...
  800d83:	68 a8 13 80 00       	push   $0x8013a8
  800d88:	6a 23                	push   $0x23
  800d8a:	68 c5 13 80 00       	push   $0x8013c5
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800da9:	75 56                	jne    800e01 <set_pgfault_handler+0x65>
		// First time through!
  ...
  800dc1:	74 14                	je     800dd7 <set_pgfault_handler+0x3b>
		{
			panic("sys_page_alloc failed");
  800dc3:	83 ec 04             	sub    $0x4,%esp
  800dc6:	68 d3 13 80 00       	push   $0x8013d3
  800dcb:	6a 24                	push   $0x24
  800dcd:	68 e9 13 80 00       	push   $0x8013e9
  800dd2:	e8 36 f3 ff ff       	call   80010d <_panic>
		}
		r = sys_env_set_pgfault_upcall(0, (void*)_pgfault_upcall); 
  800dd7:	83 ec 08             	sub    $0x8,%esp
  800dda:	68 0b 0e 80 00       	push   $0x800e0b
  ...
  800deb:	74 14                	je     800e01 <set_pgfault_handler+0x65>
		{
			panic("sys_env_set_pgfault_upcall failed");
  800ded:	83 ec 04             	sub    $0x4,%esp
  800df0:	68 f8 13 80 00       	push   $0x8013f8
  800df5:	6a 2a                	push   $0x2a
  800df7:	68 e9 13 80 00       	push   $0x8013e9
  800dfc:	e8 0c f3 ff ff       	call   80010d <_panic>
		}
  ...
  800e04:	a3 08 20 80 00       	mov    %eax,0x802008
}
  800e09:	c9                   	leave  
  800e0a:	c3                   	ret    

00800e0b <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  800e0c:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
  ...
  800e16:	8b 44 24 28          	mov    0x28(%esp),%eax
    	subl $0x4, 0x30(%esp)
  800e1a:	83 6c 24 30 04       	subl   $0x4,0x30(%esp)
   	movl 0x30(%esp), %ebp
  800e1f:	8b 6c 24 30          	mov    0x30(%esp),%ebp
    	movl %eax, (%ebp)
  800e23:	89 45 00             	mov    %eax,0x0(%ebp)
    	// pop fault_va, err
    	popl %eax
  800e26:	58                   	pop    %eax
    	popl %eax
