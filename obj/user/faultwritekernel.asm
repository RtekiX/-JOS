...
libmain(int argc, char **argv)
{
  ...
  80004d:	e8 be 00 00 00       	call   800110 <sys_getenvid>
	thisenv = envs;
  ...
  80005e:	7e 07                	jle    800067 <libmain+0x25>
		binaryname = argv[0];
...
sys_env_destroy(envid_t envid)
{
  ...
  8000f7:	68 0a 0e 80 00       	push   $0x800e0a
  8000fc:	6a 23                	push   $0x23
  8000fe:	68 27 0e 80 00       	push   $0x800e27
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80014b:	56                   	push   %esi
  80014c:	50                   	push   %eax
  80014d:	68 38 0e 80 00       	push   $0x800e38
  ...
  80015e:	e8 54 00 00 00       	call   8001b7 <vcprintf>
	cprintf("\n");
  800163:	c7 04 24 5c 0e 80 00 	movl   $0x800e5c,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002b6:	0f be 80 5e 0e 80 00 	movsbl 0x800e5e(%eax),%eax
  8002bd:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800378:	ff 24 85 00 0f 80 00 	jmp    *0x800f00(,%eax,4)
  ...
  80043f:	8b 14 85 60 10 80 00 	mov    0x801060(,%eax,4),%edx
  800446:	85 d2                	test   %edx,%edx
  800448:	75 1b                	jne    800465 <vprintfmt+0x160>
				printfmt(putch, putdat, "error %d", err);
  80044a:	50                   	push   %eax
  80044b:	68 76 0e 80 00       	push   $0x800e76
  800450:	53                   	push   %ebx
  800451:	56                   	push   %esi
  ...
  800465:	52                   	push   %edx
  800466:	68 7f 0e 80 00       	push   $0x800e7f
  80046b:	53                   	push   %ebx
  80046c:	56                   	push   %esi
  ...
  800490:	b8 6f 0e 80 00       	mov    $0x800e6f,%eax
