	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002a9:	0f be 80 7b 11 80 00 	movsbl 0x80117b(%eax),%eax
  8002b0:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80043d:	50                   	push   %eax
  80043e:	68 93 11 80 00       	push   $0x801193
  800443:	53                   	push   %ebx
  800444:	56                   	push   %esi
  ...
  800458:	52                   	push   %edx
  800459:	68 9c 11 80 00       	push   $0x80119c
  80045e:	53                   	push   %ebx
  80045f:	56                   	push   %esi
  ...
  800483:	b8 8c 11 80 00       	mov    $0x80118c,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800bab:	68 c8 13 80 00       	push   $0x8013c8
  800bb0:	6a 23                	push   $0x23
  800bb2:	68 e5 13 80 00       	push   $0x8013e5
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c2c:	68 c8 13 80 00       	push   $0x8013c8
  800c31:	6a 23                	push   $0x23
  800c33:	68 e5 13 80 00       	push   $0x8013e5
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c6e:	68 c8 13 80 00       	push   $0x8013c8
  800c73:	6a 23                	push   $0x23
  800c75:	68 e5 13 80 00       	push   $0x8013e5
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cb0:	68 c8 13 80 00       	push   $0x8013c8
  800cb5:	6a 23                	push   $0x23
  800cb7:	68 e5 13 80 00       	push   $0x8013e5
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cf2:	68 c8 13 80 00       	push   $0x8013c8
  800cf7:	6a 23                	push   $0x23
  800cf9:	68 e5 13 80 00       	push   $0x8013e5
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d34:	68 c8 13 80 00       	push   $0x8013c8
  800d39:	6a 23                	push   $0x23
  800d3b:	68 e5 13 80 00       	push   $0x8013e5
...
sys_ipc_recv(void *dstva)
{
  ...
  800d98:	68 c8 13 80 00       	push   $0x8013c8
  800d9d:	6a 23                	push   $0x23
  800d9f:	68 e5 13 80 00       	push   $0x8013e5
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800dbe:	75 56                	jne    800e16 <set_pgfault_handler+0x65>
		// First time through!
  ...
  800e00:	74 14                	je     800e16 <set_pgfault_handler+0x65>
		{
			panic("sys_env_set_pgfault_upcall failed");
  800e02:	83 ec 04             	sub    $0x4,%esp
  800e05:	68 18 14 80 00       	push   $0x801418
  800e0a:	6a 2a                	push   $0x2a
  800e0c:	68 09 14 80 00       	push   $0x801409
  800e11:	e8 0c f3 ff ff       	call   800122 <_panic>
		}
  ...
  800e19:	a3 08 20 80 00       	mov    %eax,0x802008
}
  800e1e:	c9                   	leave  
  800e1f:	c3                   	ret    
...
_pgfault_upcall:
  ...
  800e21:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
