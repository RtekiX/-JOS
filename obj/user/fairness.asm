...
sys_env_destroy(envid_t envid)
{
  ...
  800b3c:	68 a8 13 80 00       	push   $0x8013a8
  800b41:	6a 23                	push   $0x23
  800b43:	68 c5 13 80 00       	push   $0x8013c5
  800b48:	e8 ed 02 00 00       	call   800e3a <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bc9:	e8 6c 02 00 00       	call   800e3a <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bff:	68 a8 13 80 00       	push   $0x8013a8
  800c04:	6a 23                	push   $0x23
  800c06:	68 c5 13 80 00       	push   $0x8013c5
  800c0b:	e8 2a 02 00 00       	call   800e3a <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c41:	68 a8 13 80 00       	push   $0x8013a8
  800c46:	6a 23                	push   $0x23
  800c48:	68 c5 13 80 00       	push   $0x8013c5
  800c4d:	e8 e8 01 00 00       	call   800e3a <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c83:	68 a8 13 80 00       	push   $0x8013a8
  800c88:	6a 23                	push   $0x23
  800c8a:	68 c5 13 80 00       	push   $0x8013c5
  800c8f:	e8 a6 01 00 00       	call   800e3a <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800cc5:	68 a8 13 80 00       	push   $0x8013a8
  800cca:	6a 23                	push   $0x23
  800ccc:	68 c5 13 80 00       	push   $0x8013c5
  800cd1:	e8 64 01 00 00       	call   800e3a <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d29:	68 a8 13 80 00       	push   $0x8013a8
  800d2e:	6a 23                	push   $0x23
  800d30:	68 c5 13 80 00       	push   $0x8013c5
  800d35:	e8 00 01 00 00       	call   800e3a <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  800d50:	85 c0                	test   %eax,%eax
	{
		pg = (void*)-1;
  800d52:	ba ff ff ff ff       	mov    $0xffffffff,%edx
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800dbd:	85 db                	test   %ebx,%ebx
	{
		pg = (void*)-1; 
  800dbf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  ...
  800dd7:	74 20                	je     800df9 <ipc_send+0x4e>
		{ 
			//cprintf("%08x send %d to %08x\n",thisenv->env_id,val,to_env);
			break;
		}
		if (flag != -E_IPC_NOT_RECV)
  800dd9:	83 f8 f8             	cmp    $0xfffffff8,%eax
  800ddc:	74 14                	je     800df2 <ipc_send+0x47>
		{
			panic("ipc_send failed");
  800dde:	83 ec 04             	sub    $0x4,%esp
  800de1:	68 d3 13 80 00       	push   $0x8013d3
  800de6:	6a 53                	push   $0x53
  800de8:	68 e3 13 80 00       	push   $0x8013e3
  800ded:	e8 48 00 00 00       	call   800e3a <_panic>
		}
		sys_yield();
  800df2:	e8 7d fd ff ff       	call   800b74 <sys_yield>
	}
  800df7:	eb ce                	jmp    800dc7 <ipc_send+0x1c>
...
ipc_find_env(enum EnvType type)
{
  ...
  800e04:	8b 4d 08             	mov    0x8(%ebp),%ecx
	int i;
	for (i = 0; i < NENV; i++)
  800e07:	b8 00 00 00 00       	mov    $0x0,%eax
		if (envs[i].env_type == type)
  800e0c:	6b d0 7c             	imul   $0x7c,%eax,%edx
  800e0f:	81 c2 00 00 c0 ee    	add    $0xeec00000,%edx
  800e15:	8b 52 50             	mov    0x50(%edx),%edx
  800e18:	39 ca                	cmp    %ecx,%edx
  800e1a:	75 0d                	jne    800e29 <ipc_find_env+0x28>
			return envs[i].env_id;
  800e1c:	6b c0 7c             	imul   $0x7c,%eax,%eax
  800e1f:	05 00 00 c0 ee       	add    $0xeec00000,%eax
  800e24:	8b 40 48             	mov    0x48(%eax),%eax
  800e27:	eb 0f                	jmp    800e38 <ipc_find_env+0x37>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  800e2c:	3d 00 04 00 00       	cmp    $0x400,%eax
  800e31:	75 d9                	jne    800e0c <ipc_find_env+0xb>
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e3e:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  800e3f:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800e42:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800e48:	e8 08 fd ff ff       	call   800b55 <sys_getenvid>
  800e4d:	83 ec 0c             	sub    $0xc,%esp
  800e50:	ff 75 0c             	pushl  0xc(%ebp)
  800e53:	ff 75 08             	pushl  0x8(%ebp)
  800e56:	56                   	push   %esi
  800e57:	50                   	push   %eax
  800e58:	68 f0 13 80 00       	push   $0x8013f0
  800e5d:	e8 2a f3 ff ff       	call   80018c <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800e62:	83 c4 18             	add    $0x18,%esp
  800e65:	53                   	push   %ebx
  800e66:	ff 75 10             	pushl  0x10(%ebp)
  800e69:	e8 cd f2 ff ff       	call   80013b <vcprintf>
	cprintf("\n");
  800e6e:	c7 04 24 2f 11 80 00 	movl   $0x80112f,(%esp)
  800e75:	e8 12 f3 ff ff       	call   80018c <cprintf>
  800e7a:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800e7d:	cc                   	int3   
  800e7e:	eb fd                	jmp    800e7d <_panic+0x43>
