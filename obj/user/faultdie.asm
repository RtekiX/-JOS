	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ce:	e8 2d 0c 00 00       	call   800e00 <__udivdi3>
  ...
  800211:	e8 1a 0d 00 00       	call   800f30 <__umoddi3>
...
sys_env_destroy(envid_t envid)
{
  ...
  800b1b:	68 08 13 80 00       	push   $0x801308
  800b20:	6a 23                	push   $0x23
  800b22:	68 25 13 80 00       	push   $0x801325
  800b27:	e8 88 02 00 00       	call   800db4 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b9c:	68 08 13 80 00       	push   $0x801308
  800ba1:	6a 23                	push   $0x23
  800ba3:	68 25 13 80 00       	push   $0x801325
  800ba8:	e8 07 02 00 00       	call   800db4 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bde:	68 08 13 80 00       	push   $0x801308
  800be3:	6a 23                	push   $0x23
  800be5:	68 25 13 80 00       	push   $0x801325
  800bea:	e8 c5 01 00 00       	call   800db4 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c20:	68 08 13 80 00       	push   $0x801308
  800c25:	6a 23                	push   $0x23
  800c27:	68 25 13 80 00       	push   $0x801325
  800c2c:	e8 83 01 00 00       	call   800db4 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c62:	68 08 13 80 00       	push   $0x801308
  800c67:	6a 23                	push   $0x23
  800c69:	68 25 13 80 00       	push   $0x801325
  800c6e:	e8 41 01 00 00       	call   800db4 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ca4:	68 08 13 80 00       	push   $0x801308
  800ca9:	6a 23                	push   $0x23
  800cab:	68 25 13 80 00       	push   $0x801325
  800cb0:	e8 ff 00 00 00       	call   800db4 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  800d08:	68 08 13 80 00       	push   $0x801308
  800d0d:	6a 23                	push   $0x23
  800d0f:	68 25 13 80 00       	push   $0x801325
  800d14:	e8 9b 00 00 00       	call   800db4 <_panic>
...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800d2e:	75 56                	jne    800d86 <set_pgfault_handler+0x65>
		// First time through!
  ...
  800d46:	74 14                	je     800d5c <set_pgfault_handler+0x3b>
		{
			panic("sys_page_alloc failed");
  800d48:	83 ec 04             	sub    $0x4,%esp
  800d4b:	68 33 13 80 00       	push   $0x801333
  800d50:	6a 24                	push   $0x24
  800d52:	68 49 13 80 00       	push   $0x801349
  800d57:	e8 58 00 00 00       	call   800db4 <_panic>
		}
		r = sys_env_set_pgfault_upcall(0, (void*)_pgfault_upcall); 
  800d5c:	83 ec 08             	sub    $0x8,%esp
  800d5f:	68 90 0d 80 00       	push   $0x800d90
  ...
  800d70:	74 14                	je     800d86 <set_pgfault_handler+0x65>
		{
			panic("sys_env_set_pgfault_upcall failed");
  800d72:	83 ec 04             	sub    $0x4,%esp
  800d75:	68 58 13 80 00       	push   $0x801358
  800d7a:	6a 2a                	push   $0x2a
  800d7c:	68 49 13 80 00       	push   $0x801349
  800d81:	e8 2e 00 00 00       	call   800db4 <_panic>
		}
  ...
  800d89:	a3 08 20 80 00       	mov    %eax,0x802008
}
  800d8e:	c9                   	leave  
  800d8f:	c3                   	ret    

00800d90 <_pgfault_upcall>:
...
_pgfault_upcall:
  ...
  800d91:	a1 08 20 80 00       	mov    0x802008,%eax
	call *%eax
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800db8:	53                   	push   %ebx
	...
	va_start(ap, fmt);
  800db9:	8d 5d 14             	lea    0x14(%ebp),%ebx

	// Print the panic message
	cprintf("[%08x] user panic in %s at %s:%d: ",
  800dbc:	8b 35 00 20 80 00    	mov    0x802000,%esi
  800dc2:	e8 6d fd ff ff       	call   800b34 <sys_getenvid>
  800dc7:	83 ec 0c             	sub    $0xc,%esp
  800dca:	ff 75 0c             	pushl  0xc(%ebp)
  800dcd:	ff 75 08             	pushl  0x8(%ebp)
  800dd0:	56                   	push   %esi
  800dd1:	50                   	push   %eax
  800dd2:	68 7c 13 80 00       	push   $0x80137c
  800dd7:	e8 8f f3 ff ff       	call   80016b <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  800ddc:	83 c4 18             	add    $0x18,%esp
  800ddf:	53                   	push   %ebx
  800de0:	ff 75 10             	pushl  0x10(%ebp)
  800de3:	e8 32 f3 ff ff       	call   80011a <vcprintf>
	cprintf("\n");
  800de8:	c7 04 24 ba 10 80 00 	movl   $0x8010ba,(%esp)
  800def:	e8 77 f3 ff ff       	call   80016b <cprintf>
  800df4:	83 c4 10             	add    $0x10,%esp
	...
	while (1)
		asm volatile("int3");
  800df7:	cc                   	int3   
  800df8:	eb fd                	jmp    800df7 <_panic+0x43>
